...
public:
	OvertureController(int port, bool isXbox, int emulatedPort);

private:
	bool isXbox;
	std::shared_ptr<frc2::CommandXboxController> xboxController;
	std::shared_ptr<frc2::CommandPS5Controller> ps5Controller;
	std::shared_ptr<frc2::CommandGenericHID> abstractedController;
	std::shared_ptr<frc2::CommandXboxController> emulatedController;
