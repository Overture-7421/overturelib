...
public:
	HeadingSpeedsHelper(frc::ProfiledPIDController<units::radian_t> headingController, SwerveChassis* chassis);
	void setTargetAngle(units::radian_t targetAngle);	
	void AlterSpeed(frc::ChassisSpeeds &inputSpeed) override;

private:
	frc::ProfiledPIDController<units::radian_t> headingController;
