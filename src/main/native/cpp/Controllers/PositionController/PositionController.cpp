...
#include "OvertureLib/Controllers/PositionController/PositionController.h"

PositionController::PositionController(double kP, double kI, double kD,
		frc::TrapezoidProfile<units::meters>::Constraints profile) : frc::ProfiledPIDController<
		units::meters>(kP, kI, kD, profile) {
	calculatedValue = 0;
}
