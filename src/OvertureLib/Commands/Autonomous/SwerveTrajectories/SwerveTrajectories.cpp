...
#include "SwerveTrajectories.h"

SwerveTrajectories::SwerveTrajectories(SwerveChassis* swerveChassis, pathplanner::PathPlannerTrajectory trajectory, frc2::PIDController xController, frc2::PIDController yController, frc2::PIDController rController):
...
void SwerveTrajectories::Initialize() {
...
void SwerveTrajectories::Execute() {
  alignCommand->Execute();
}

// Called once the command ends or is interrupted.
void SwerveTrajectories::End(bool interrupted) {
  alignCommand->End(interrupted);
}

// Returns true when the command should end.
bool SwerveTrajectories::IsFinished() {
